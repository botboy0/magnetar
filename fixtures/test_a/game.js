var Module = {
    arguments: ["/"],
    preRun: [function(){
        console.log('FIRING PRERUN: Injecting Lua code into the virtual filesystem...');
        try {
        Module.FS_createDataFile('/', 'main.lua', sessionStorage.getItem('magnetar_code') || '', true, true,true);    
        console.log('Lua code injected successfully!'); 
        } catch (e) {
            console.error('Error injecting Lua code:', e);
        }
...
(function() {
    ...
    loadPackage({"files": [{"filename": "/game.love", "start": 0, "end": 1450}], "remote_package_size": 1450, "package_uuid": "934bba88-20a4-45f1-b461-8241ffb2db26"});
